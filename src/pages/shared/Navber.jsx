...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r py-6 from-purple-700 via-purple-500 to-indigo-600">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <NavLink exact to="/" className="text-white font-bold w-12  rounded-full text-lg">
              <img src="https://st3.depositphotos.com/5366154/13886/i/1600/depositphotos_138866570-stock-photo-fire-letter-m-of-burning.jpg"  alt="" />
            </NavLink>
          </div>
